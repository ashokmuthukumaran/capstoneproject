...
generated = "data\\generated_tickets.csv"
logfile = "data\\processing_log.csv"
metrics = "data\\metrics.csv"

colp = st.columns(3)
with colp[0]:
    st.write("data\\Generated Tickets CSV:", os.path.abspath(generated))
with colp[1]:
    st.write("data\\Processing Log CSV:", os.path.abspath(logfile))
with colp[2]:
    st.write("data\\Metrics CSV:", os.path.abspath(metrics))
